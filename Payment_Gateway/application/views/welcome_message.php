  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title" id="exampleModalLabel" > <img src="../../Amorio_Logo.png" alt="Amorio" /> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<b>Your payment has been processed successfully</b></h6>
      ...
      <div class="modal-body">
		...
		<?php
		//$val= $_POST['result'];
	//	$len = isset($arr['status']) ? count($arr['status']) : 0;  ?>
