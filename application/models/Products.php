...
public function get_products() {
 ...
 public function get_sales_product_history($pid) {
     ...
     $this->db->select('a.product_id,a.product_name,a.bundle_no,a.invoice_id,c.commercial_invoice_number');
        $this->db->from('invoice_details a');
   ...
   public function get_expense_product_history($pid) {
         ...
         $this->db->select('a.product_id,a.product_name,a.bundle_no,b.chalan_no,a.purchase_id,');
