...
<div class="row">
       ...
       <div class="col-sm-6 text-center" style="color:white;"><h3><?php echo $header; ?></h3></div>
        ...
        <tr>  <td style="100px;font-weight:bold;"> <?php echo display('Company name') ?> </td><td style="width:10px;">:</td><td> <?php echo $company; ?></td></tr>
        <tr>   <td style="100px;font-weight:bold;"> <?php echo display('Address') ?> </td><td style="width:10px;">:</td><td> <?php echo $address; ?></td></tr>
        <tr>   <td style="100px;font-weight:bold;"> <?php echo display('Email') ?> </td><td style="width:10px;">:</td><td> <?php echo $email; ?></td></tr>
        <tr>   <td style="100px;font-weight:bold;"> <?php echo display('Contact') ?> </td><td style="width:10px;">:</td><td> <?php echo $phone; ?></td></tr>
</tr>        
