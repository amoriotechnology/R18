...
<div class="col-sm-6">
            <div class="form-group row">
                ...
                <input type="text" tabindex="3" class="form-control" name="invoice_no" value="<?php echo $purchase_info[0]['invoice_no']; ?>" readonly />
             </div>
            </div>
        </div>
       ...
       <!--  <div class="col-sm-6">
         ...
         <div class="col-sm-6">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <?php $date = date('Y-m-d'); ?>
                    <input type="date" required tabindex="2" class="form-control " name="invoice_date" value="<?php echo $purchase_info[0]['invoice_date']; ?>" id="date"  />
                </div>
            </div>
        </div>
    </div>
...
<div class="col-sm-6">
                               ...
                               <div class="form-group row">
                                    ...
                                    <label for="supplier_sss" class="col-sm-1 col-form-label"><?php echo display('From')?>
                                     ...
                                     <div class="col-sm-3">
                                        ...
                                        <input type="time" required tabindex="2" class="form-control " name="delivery_time_from" value="{delivery_time_from}" id="time"  />
                                    </div>
                                    <label for="delivery_time" class="col-sm-1 col-form-label"><?php echo display('TO' )?>
                                    </label>
                                    <div class="col-sm-3">
                                    
                                        <input type="time" required tabindex="2" class="form-control " name="delivery_time_to" value="{delivery_time_to}" id="time"  />
                                    </div>
        ...
        <div class="col-sm-6">
           <div class="form-group row">
                <label for="upload_image" class="col-sm-4 col-form-label"><?php echo display('Attachments') ?>
                </label>
                 <div class="col-sm-8">
                    <input type="file" class="form-control"  tabindex="2" class="form-control " name="upload_image" value="{upload_image}" id="upload_image"/>
                </div>
        ...
        <div class="col-sm-6">
           <div class="form-group row">
                <label for="truck_no" class="col-sm-4 col-form-label"><?php echo display('Truck No') ?>
                </label>
                 <div class="col-sm-8">
                    <input type="text" class="form-control" required tabindex="2" class="form-control " name="truck_no" value="{truck_no}" id="truck_no"/>
                </div>
      ...
      <tr>
        ...
        <td><input  type="text"  readonly id="balance"  value="<?php echo $purchase_info[0]['balance']; ?>" name="balance"  required   /></td>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
 <textarea rows="4" cols="50" name="remarks" class=" form-control" placeholder="Remarks" id=""><?php   if(!empty($purchase_info[0]['remarks'])){ echo $purchase_info[0]['remarks'];} ?></textarea>
