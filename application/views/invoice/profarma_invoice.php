...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('Create Quotation') ?></h1>
            <small></small>
            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <a style="background-color:#38469f;color:white;" href="<?php echo base_url('Cinvoice/manage_profarma_invoice') ?>" class="btn  m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('Manage Quotation') ?> </a>
...
#download_select:focus option:first-of-type , #print_select:focus option:first-of-type{
    display: none;
                                ...
                                <input list="magicHouses" name="prodt[]" id="prodt_1"  class="form-control product_name" onfocus="this.value=''" onchange="this.blur();"  placeholder="Search Product" />
  ...
  <span class="input-symbol-euro"><input type="text" id="cost_sq_ft_1"  name="cost_sq_ft[]" readonly  style="width:70px;" value="0.00"  class="cost_sq_ft form-control" ></span>
      ...
      <span class="input-symbol-euro"> <input type="text"  id="cost_sq_slab_1" name="cost_sq_slab[]" readonly   style="width:70px;" value="0.00"  class="form-control"/></span>
...
<table border="0" style="table-layout: auto;" class="overall table table-bordered table-hover">
  ...
  <tr>
        ...
        <td colspan="1" style="border:none;padding-bottom: 40px;"><span class="input-symbol-euro"><input type="text" id="Over_all_Total" name="Over_all_Total"  style="width:200px;" class="form-control" value="0.00"  readonly="readonly"  /> </span></td>
         <td colspan="4" style="width:250px;text-align:right;border:none;"><b><?php echo display('TAX DETAILS')?> :</b></td><td colspan="1" style="border:none;">  <span class="input-symbol-euro">     <input type="text" class="form-control" style="width:150px;"  id="tax_details" value="0.00" name="tax_details"  readonly="readonly" /></span></td>
</tr>
   <tr>
...
<textarea rows="4" cols="50" id="details" name="ac_details" class=" form-control" placeholder='Account Details/Additional Information' ><?php   if(!empty($update_invoice_set[0]->account)){echo $update_invoice_set[0]->account;} ?></textarea>
...
<textarea rows="4" cols="50" id="remarks" name="remark" class=" form-control" placeholder='Remarks/Conditions' ><?php   if(!empty($update_invoice_set[0]->remarks)){ echo $update_invoice_set[0]->remarks;} ?></textarea>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="submit" id="add_trucking" class="btn btn-large" style="color:white;background-color: #38469f;" name="add-trucking" value=<?php echo display('Save') ?> />
                                            ...
                                            <td>&nbsp;</td>
                                            <td class="amt">    <a  style="color:white;background-color: #38469f;"  id="final_submit" class='final_submit btn'><?php echo display('Submit') ?></a></td>
     <td class="amt">&nbsp;</td>
<td class="amt"><a id="download" style="color:white;background-color: #38469f;" class='btn'><?php echo display('Download')?></a>
...
<td><input  type="text"  readonly name="amount_to_pay" id="amount_to_pay"  style="width:332%;"   class="form-control" required   /></td>
...
<table border="0">
      <tr>
        <td class="cus" name="cus"></td>
        <td><input  type="text"  readonly name="amount_received" value="0.00" style="width:332%;"  id="amount_received" class="form-control"required   /></td>
     </tr>
   </table>
...
<table border="0">
      <tr>
        <td class="cus" name="cus"></td>
        <td><input  type="text"   readonly name="balance_modal"   style="width:332%;"  id="balance_modal" class="form-control" required  /></td>
     </tr>
   </table>
</div>
</div> 
...
<table border="0">
      <tr>
        <td class="cus" name="cus"></td>
        <td><input  type="text"   name="payment" id="payment_from_modal"    style="width:332%;"  class="form-control"required   /></td>
     </tr>
   </table>
