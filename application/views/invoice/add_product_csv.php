                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              for($i = 0; $i<count($arr); $i++){
                               ...
                               <td>".$i."</td> <td><input style='width: 130px !important;' type='text' class='form-control' name='invoice_id[]' value='". $arr[$i]['invoice_id']." '></td> 

                               <td><input style='width: 130px !important;' type='text' class='form-control' name='date[]' value='". $arr[$i]['date']."'></td> 

                               <td><input style='width: 130px !important;' type='text' class='form-control' name='commercial_invoice_number[]' value='". $arr[$i]['commercial_invoice_number']." '></td>

                               <td> <input style='width: 130px !important;' type='text' class='form-control' name='payment_type[]' value='". $arr[$i]['payment_type']."'></td>

                               <td><input style='width: 130px !important;' type='text' class='form-control' name='container_no[]' value='". $arr[$i]['container_no']."'></td>

                               <td><input style='width: 130px !important;' type='text' class='form-control' name='bl_no[]' value='". $arr[$i]['bl_no']." '></td>
                               ...
                               <td><input style='width: 130px !important;' type='text' class='form-control' name='billing_address[]' value='". $arr[$i]['billing_address']."'></td> 

                               <td><input style='width: 130px !important;' type='text' class='form-control' name='payment_terms[]' value='". $arr[$i]['payment_terms']."'></td> 

                               <td><input style='width: 130px !important;' type='text' class='form-control' name='port_of_discharge[]' value='". $arr[$i]['port_of_discharge']."'></td> 

                                <td><input style='width: 130px !important;' type='text' class='form-control' name='number_of_days[]' value='". $arr[$i]['number_of_days']."'></td>

                                <td><input style='width: 130px !important;' type='text' class='form-control' name='payment_due_date[]' value='". $arr[$i]['payment_due_date']."'></td>

                                <td><input style='width: 130px !important;' type='text' class='form-control' name='etd[]' value='". $arr[$i]['etd']."'></td>

                                <td><input style='width: 130px !important;' type='text' class='form-control' name='eta[]' value='". $arr[$i]['eta']."'></td>
...
<!-- <script type="text/javascript">
   ...
   dataString[csrfName] = csrfHash;
    ...
    $.ajax({
        type:"POST",
        dataType:"json",
        url:"<?php echo base_url(); ?>Cinvoice/bulkupload",
        data:$("#csv_details").serialize(),

        success:function (data) {
        console.log(data);
            var input_hdn2="Products Uploaded Successfully";
