<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('cash_flow_report') ?></h1>
            <small><?php //echo display('cash_flow_report') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('accounts') ?></a></li>
                <li class="active" style="color:orange;"><?php echo display('cash_flow_report') ?></li>
            </ol>
        </div>
    </section>
    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <?php echo  form_open_multipart('accounts/cash_flow_report_search') ?>
                <div class="row" id="">
                    <div class="col-sm-6">
