    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="row" id="">
                    <div class="col-sm-6">
                        <?php echo form_open_multipart('accounts/balance_sheet') ?>  
                        <div class="form-group row">
                           
                           <label for="date" class="col-sm-4 col-form-label"><?php echo display('from_date') ?></label>
                           <div class="col-sm-8">
                                <input type="date" name="dtpFromDate" value="<?php echo date('Y-m-d')?>"
						  ...
						  <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" name="dtpToDate" value="<?php echo date('Y-m-d')?>"
