...
<!-- 
 <div class="col-sm-1" >
           <i class="fa fa-cog"  aria-hidden="true" id="myBtn" style="font-size:25px;  text-align: -webkit-right;" onClick="columnSwitchMODAL()"></i> 
           </div>
<div class="col-sm-2" >
    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
           ...
           <td align="left" class="print-table-tr">
            ...
            <h3 style="text-align: center;"><?php echo display('trial_balance')?><br/>
...
<option value="6">Credit</option>
  ...
  <div class="sortableTable__discard">
                ...
                <table width="100%" class="table table-bordered table_boxnew" cellpadding="5" id="ProfarmaInvList" cellspacing="0">
        ...
        ?>
                ...
                <td data-col="2" class="2" align="center">&nbsp;</td>
                  ...
                  <td data-col="5" class="5" align="right"><strong><?php echo number_format($TotalDebit); ?></strong></td>
