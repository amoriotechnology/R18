            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title"  style="height:55px;">
...
<iframe id="txtArea1" style="display:none"></iframe>
                ...
                <div id="myModal_colSwitch"  class="modal_colSwitch">
                    ...
                    <span class="close_colSwitch">&times;</span>
                          ...
                          <br><input type="checkbox"  data-control-column="5" checked = "checked" class="5"   value="5"/>&nbsp;<?php echo display('category') ?><br>
        ...
        <div class="col-sm-2"  ><br>
                      ...
                      <div class="col-sm-3"  ><br>
                          ...
                          <br><input type="checkbox"  data-control-column="11" checked = "checked" class="11"   value="11"/>&nbsp;<?php echo display('Account Sub category') ?><br>
                          <br><input type="checkbox"  data-control-column="12" checked = "checked" class="12"  value="12"/>&nbsp;<?php echo display('Product Sub Category') ?><br>
