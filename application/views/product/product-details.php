...
<div class="content-wrapper">
 ...
 <input type="hidden" value="<?php echo $product_info[0]['country']; ?>"  id="country_flag"/>
     ...
     <table class="table table-bordered">
                             ...
                             <img  id="flag" alt="<?php echo $product_info[0]['country']; ?>" width="500" height="200" style="alignment:centre"> 
  ...
  <span class="input-symbol-euro"><input type="text" id="cost_sq_ft_<?php echo $i; ?>"  name="cost_sq_ft[]"  style="width:60px;"  readonly  class="cost_sq_ft form-control"   value="<?php echo $apd['cost_sqft']; ?>"></span>
      ...
      <span class="input-symbol-euro">   <input type="text"  id="sales_slab_amt_<?php echo $i; ?>" name="sales_slab_amt[]"  readonly style="width:60px;"      class="sales_slab_amt form-control"  value="<?php echo $apd['sales_slab_price']; ?>" /></td> </span>
                                            ...
                                            <td >
                                                ...
                                                <a href="#"  class="client-add-btn btn " style="color:white;background-color:#38469f;"   data-toggle="modal"  data-target="#viewimg_<?php  echo $i; ?>"> <i class="fa fa-image" style="font-size:21px"></i></a>
...
<?php $str = substr(strrchr($apd['img'], '/'), 1); 
...
<input type="file" name="image[]" id="fileChooser_<?php echo $i; ?>" class="dropify"   data-height="300" data-default-file="<?php echo $apd['img'];  ?>"/>                   </div>
                                                      ...
                                                      <td >
                                           <a class="btn  notebtn" style="color:white;background-color:#38469f;" id="newNote_<?php echo $i; ?>" name="newNote[]"><i class='fa fa-book' style='font-size:21px'></i></a>
        ...
        <br/>
        <div style="color:white;background-color:#38469f;display: none;" class="btn add" id="button_<?php echo $i; ?>">
            Add
        </div><br/>
 ...
 <label class="switch">
      <input type="checkbox" class="checkbox switch-input"  value=""  id="blockcheck_<?php echo $i; ?>" name="blockcheck[]">
      <span class="switch-label" data-on="On" data-off="Off"></span>
      <span class="switch-handle"></span>
    </label>
                               <input type="hidden" name="block[]" class="block" value="<?php  echo $apd['block']; ?>"  id="block_<?php echo $i; ?>" />              
                                            </td>  
           ...
           <span class="input-symbol-euro">    <input type="text" id="Total" name="total"  readonly  class="form-control" style="width: 80px"  value="<?php echo $product_info[0]['oa_total']; ?>"   readonly="readonly"  /> </span>
                            ...
                            <div class="col-sm-9" style="text-align:centre;">
                                <input type="submit" id="add-product" class="btn  m-b-5 m-r-2" style="color:white;background-color:#38469f;" name="add-product" value="<?php echo display('save') ?>" tabindex="10"/>
                                </div>
...
<div class="modal fade modal-success" id="product_hty">
                <div class="modal-dialog" >
                   <div class="modal-content"  style="    width: 1000; height: auto;">
                   ...
                   <div class="modal-header" style="color:white;background-color:#38469f;">
                        ...
                        <div class="modal-body" style="width:170%">
                       <div class="panel-body" style="width:170%">
...
<?php  
  ...
  ?>
    <tr>
      <!-- <td colspan="3 " style="text-align:center;">New Sale</td> -->
      <td colspan="3" style="text-align:center;"><?php echo $sale['bundle_no']; ?></td>
      <td colspan="3"  style="text-align:center;" ><?php echo $sale['commercial_invoice_number']; ?></td>
          <td colspan="2"  style="text-align:center;" ><a class="btnclr btn  btn-sm" style="background-color: #3ca5de; color: #fff;" target="_blank" href="<?php echo base_url()?>Cinvoice/invoice_update_form/<?php echo  $sale['invoice_id'];  ?>"><i class="fa fa-external-link" aria-hidden="true"></i></a></td>
    </tr>
    <?php  } ?>
    <!-- <tr><td colspan="3 " style="text-align:center;">Profarma Invoice</td><td colspan="3" style="text-align:center;"><?php //echo $product_info[0]['p_quantity']; ?></td><td colspan="3"  style="text-align:center;" ><?php //echo $product_info[0]['p_quantity']; ?></td></tr> -->
...
<?php  
  ...
  ?>
    <tr>
      <!-- <td colspan="3 " style="text-align:center;">New Sale</td> -->
      <td colspan="3" style="text-align:center;"><?php echo $expense['bundle_no']; ?></td>
      <td colspan="3"  style="text-align:center;" ><?php echo $expense['chalan_no']; ?></td>
          <td colspan="2"  style="text-align:center;" ><a class="btnclr btn  btn-sm" style="background-color: #3ca5de; color: #fff;" target="_blank" href="<?php echo base_url()?>Cpurchase/purchase_update_form/<?php echo  $expense['purchase_id'];  ?>"><i class="fa fa-external-link" aria-hidden="true"></i></a></td>
    </tr>
      <?php  } ?>
    <!-- <tr><td colspan="3 " style="text-align:center;">Profarma Invoice</td><td colspan="3" style="text-align:center;"><?php //echo $product_info[0]['p_quantity']; ?></td><td colspan="3"  style="text-align:center;" ><?php //echo $product_info[0]['p_quantity']; ?></td></tr> -->
...
var shoppingCart = (function() {
  ...
  function Item(product_id, description, thickness, supplier_block_no,supplier_slab_no, g_width, g_height, gross_sq_ft, bundle_no, slab_no, n_width, n_height, net_sq_ft, cost_sq_ft, cost_sq_slab, sales_amt_sq_ft, sales_slab_amt, weight, origin, total_amt,  count) {
  ...
  // else{
  //   alert("Add Produts to view cart");
  // }
  ...
  // Add to cart
    obj.addItemToCart = function(product_id, description, thickness, supplier_block_no,supplier_slab_no, g_width, g_height, gross_sq_ft, bundle_no, slab_no, n_width, n_height, net_sq_ft, cost_sq_ft, cost_sq_slab, sales_amt_sq_ft, sales_slab_amt, weight, origin, total_amt,  count) {
    for(var item in cart) {
      if(cart[item].product_id == product_id && cart[item].description == description && cart[item].thickness == thickness && cart[item].supplier_block_no == supplier_block_no && cart[item].supplier_slab_no == supplier_slab_no && cart[item].g_width == g_width && cart[item].g_height == g_height && cart[item].gross_sq_ft == gross_sq_ft && cart[item].bundle_no == bundle_no && cart[item].slab_no == slab_no && cart[item].n_width == n_width && cart[item].n_height == n_height && cart[item].net_sq_ft == net_sq_ft && cart[item].cost_sq_ft == cost_sq_ft && cart[item].cost_sq_slab == cost_sq_slab && cart[item].sales_amt_sq_ft == sales_amt_sq_ft && cart[item].sales_slab_amt == sales_slab_amt && cart[item].weight == weight && cart[item].origin == origin && cart[item].total_amt == total_amt) {
        cart[item].count ++;
        saveCart();
        return;
      }
    }
    var item = new Item(product_id, description, thickness, supplier_block_no,supplier_slab_no, g_width, g_height, gross_sq_ft, bundle_no, slab_no, n_width, n_height, net_sq_ft, cost_sq_ft, cost_sq_slab, sales_amt_sq_ft, sales_slab_amt, weight, origin, total_amt,  count);
    cart.push(item);
    saveCart();
  }
  // Set count from item
  obj.setCountForItem = function(product_id, description, thickness, supplier_block_no,supplier_slab_no, g_width, g_height, gross_sq_ft, bundle_no, slab_no, n_width, n_height, net_sq_ft, cost_sq_ft, cost_sq_slab, sales_amt_sq_ft, sales_slab_amt, weight, origin, total_amt,  count) {
    for(var i in cart) {
      if (cart[item].product_id == product_id && cart[item].description == description && cart[item].thickness == thickness && cart[item].supplier_block_no == supplier_block_no && cart[item].supplier_slab_no == supplier_slab_no && cart[item].g_width == g_width && cart[item].g_height == g_height && cart[item].gross_sq_ft == gross_sq_ft && cart[item].bundle_no == bundle_no && cart[item].slab_no == slab_no && cart[item].n_width == n_width && cart[item].n_height == n_height && cart[item].net_sq_ft == net_sq_ft && cart[item].cost_sq_ft == cost_sq_ft && cart[item].cost_sq_slab == cost_sq_slab && cart[item].sales_amt_sq_ft == sales_amt_sq_ft && cart[item].sales_slab_amt == sales_slab_amt && cart[item].weight == weight && cart[item].origin == origin && cart[item].total_amt == total_amt) {
        cart[i].count = count;
        break;
  ...
  // obj.removeItemFromCart = function(description, thickness, supplier_block_no, supplier_slab_no, gross_sq_ft, bundle_no, slab_no, net_sq_ft, cost_sq_ft, cost_sq_slab, sales_amt_sq_ft, sales_slab_amt, weight, origin, total_amt) {
  //     for(var item in cart) {
  //       if(cart[item].description == description && cart[item].thickness == thickness && cart[item].supplier_block_no == supplier_block_no && cart[item].supplier_slab_no == supplier_slab_no && cart[item].gross_sq_ft == gross_sq_ft && cart[item].bundle_no == bundle_no && cart[item].slab_no == slab_no && cart[item].net_sq_ft == net_sq_ft && cart[item].cost_sq_ft == cost_sq_ft && cart[item].cost_sq_slab == cost_sq_slab && cart[item].sales_amt_sq_ft == sales_amt_sq_ft && cart[item].sales_slab_amt == sales_slab_amt && cart[item].weight == weight && cart[item].origin == origin && cart[i].total_amt == total_amt) {
  //         cart[item].count --;
  ...
  // obj.removeItemFromCartAll = function(description, thickness, supplier_block_no, supplier_slab_no, gross_sq_ft, bundle_no, slab_no, net_sq_ft, cost_sq_ft, cost_sq_slab, sales_amt_sq_ft, sales_slab_amt, weight, origin, total_amt) {
  //   for(var item in cart) {
  //       console.log(cart);
  //     if(cart[item].description == description && cart[item].thickness == thickness && cart[item].supplier_block_no == supplier_block_no && cart[item].supplier_slab_no == supplier_slab_no && cart[item].gross_sq_ft == gross_sq_ft && cart[item].bundle_no == bundle_no && cart[item].slab_no == slab_no && cart[item].net_sq_ft == net_sq_ft && cart[item].cost_sq_ft == cost_sq_ft && cart[item].cost_sq_slab == cost_sq_slab && cart[item].sales_amt_sq_ft == sales_amt_sq_ft && cart[item].sales_slab_amt == sales_slab_amt && cart[item].weight == weight && cart[item].origin == origin && cart[item].total_amt == total_amt) {
  //       cart.splice(item, 1);
  ...
  obj.listCart = function() {
    ...
    for(i in cart) {
      ...
      // itemCopy.total = Number(item.description * item.thickness * item.count).toFixed(2);
...
$('.add-to-cart').click(function(event) {
  ...
  // console.log(origin);
  shoppingCart.addItemToCart(product_id, description, thickness, supplier_block_no, supplier_slab_no, g_width, g_height, gross_sq_ft, bundle_no, slab_no, n_width, n_height, net_sq_ft, cost_sq_ft, cost_sq_slab, sales_amt_sq_ft, sales_slab_amt, weight, origin, total_amt, 1);
  displayCart();
});
