    ...
    <table class="table table-bordered normalinvoice table-hover" id="normalinvoice_<?php  echo $m; ?>" >
            <thead>
                  <tr style="font-weight:bold;height:40px;font-size:12px;background-color:<?php echo $color; ?>">
                      <th rowspan="1" class="absorbing-column text-center class" style=" font-size:12px;width:13px;"><?php  echo  display('Account Category Name');?></th>
                    <th rowspan="1" class="text-center class"style=" font-size:12px;width:13px;"><?php  echo  display('Account Category'); ?></th>
                    <th rowspan="1" class="text-center class"style=" font-size:12px;width:13px;"><?php  echo  display('Account Sub category');?></th>
                    <th rowspan="1" class="text-center class"style=" font-size:12px;width:15px;"><?php echo display('description'); ?></th>
                    <th rowspan="1" class="text-center class"style=" font-size:12px;width:10px;"><?php echo display('amount'); ?></th> 
                     </tr> 
