...
<div id="block_container">
                            ...
                            echo $voucher_n = 'T'. $curYear.$month.'-'.'1';
                             ...
                             <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <?php $date = date('Y-m-d'); ?>
                                        <input type=date required tabindex="2" class="form-control " name="invoice_date"  style="width:100%;" value="<?php echo $date; ?>" id="date"  />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="supplier_sss" class="col-sm-4 col-form-label"><?php  echo display('Trucking Company');?>
                                       ...
                                       <div class="col-sm-7">
                                       <select name="shipment_company" id="supplier_id" class="form-control " style="width:100%;" required="" tabindex="1">
                                    ...
                                    <div class="col-sm-1">
                                    <a href="#" class="client-add-btn btn btn-info" aria-hidden="true" data-toggle="modal" style="color:white;background-color:#38469f;"  data-target="#add_vendor"><i class="fa fa-user"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="supplier_sss" class="col-sm-4 col-form-label"><?php echo display('Delivery date') ?>
                                     ...
                                     <div class="col-sm-8">
                                        <?php $date = date('Y-m-d'); ?>
                                        <input type="date" required tabindex="2" class="form-control "  style="width:100%;" name="delivery_date" value="<?php echo $date; ?>" id="date"  />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="supplier_sss" class="col-sm-4 col-form-label"><?php echo display('Shipment / BL Number');?>
                                     ...
                                     <div class="col-sm-8">
                                        <input type="text" required tabindex="2" class="form-control" name="shipment_bl_number"  style="width:100%;" value="" id="date"  />
                                    </div>
                                </div>
                            </div>
                        </div>
       ...
       <td>  <span class="input-symbol-euro">  <input type="text" name="product_rate[]" required="" style="width:150%;" class="productrate form-control"   id="product_rate_1" class="product_rate_1" placeholder="0.00" value="" min="0" tabindex="7"/></span></td>
     ...
     <td> <span class="input-symbol-euro">   <input class="total_price form-control" type="text"  name="total_price[]" id="total_price_1" value="0.00" readonly="readonly" /></span></td>
      ...
      <tr>
        ...
        <td style="padding-bottom:30px;"> <span class="input-symbol-euro">     <input type="text" id="Total" class="form-control text-right" name="total" value="0.00" readonly="readonly" /></span></td>
     </tr>
   </table>
                                           </td>
