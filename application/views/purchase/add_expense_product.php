            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                       <a href="<?php echo base_url('assets/data/csv/product/newexpense.csv') ?>" style="background-color:#38469f;color:white;" class="btn btn-primary text-white pull-right"><i class="fa fa-download"></i> Download Sample File</a>
                            <span class="text-warning">The first line in downloaded csv file should remain as it is. Please do not change the order of columns.</span><br>The correct column order is <span class="text-info">(Vendor, Expense/BillDate, Payment due date, Product name, quantity, rate)<br></span> &amp; you must follow this.<br>Please make sure the csv file is UTF-8 encoded and not saved with byte order mark (BOM).<p>The images should be uploaded in <strong>uploads</strong> folder.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                     ...
                     <?php echo form_open_multipart('Cpurchase/uploadExpensecsv',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_product'))?>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-6">
                        ...
                        <input type="submit" id="add-product" style="background-color:#38469f;color:white;" class="btn
                        btn-primary btn-large" name="add-product"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              for($i = 0; $i<count($arr); $i++){
                               ...
                               <td><input style='width: 130px !important;' type='text' class='form-control' name='description[]' value='". $arr[$i]['description']."  '></td>

                               <td><input style='width: 130px !important;' type='text' class='form-control' name='remarks[]' value='". $arr[$i]['remarks']."'></td> 
...
<!-- <script type="text/javascript">
   ...
   dataString[csrfName] = csrfHash;
    ...
    $.ajax({
        type:"POST",
        dataType:"json",
        url:"<?php echo base_url(); ?>Cpurchase/bulknewexpense",
