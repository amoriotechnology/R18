                        ...
                        <div class="row">
                             ...
                             <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" tabindex="3"  readonly value="{invoice_no}" class="form-control" name="invoice_no" placeholder="<?php echo display('invoice_no') ?>"  style="width:135%;"  id="invoice_no" />
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
 ...
 <?php }?>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"> 
                                   <select name="shipment_company" id="supplier_id" class="form-control "  style="width:136%;" required="" tabindex="1">
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="supplier_sss" class="col-sm-4 col-form-label"><?php echo display('Container/Goods Pickupdate') ?>
                                       ...
                                       <div class="col-sm-8">
                                        <?php $date = date('Y-m-d'); ?>
                                        <input type="date" required tabindex="2" class="form-control datepicker" name="container_pick_up_date" value="<?php echo $date; ?>" id="date"  />
                                    </div>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="supplier_sss" class="col-sm-4 col-form-label"><?php echo display('Delivery date') ?>
                                     ...
                                     <div class="col-sm-8">
                                        <?php $date = date('Y-m-d'); ?>
                                        <input type="date" required tabindex="2" class="form-control datepicker" name="delivery_date" value="<?php echo $date; ?>" id="date"  />
                                    </div>
      ...
      <tr>
        ...
        <td><input  type="text"  readonly id="balance"  value="<?php echo $purchase_info[0]['balance']; ?>" name="balance"  required   /></td>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                    <textarea rows="4" style="border:1px solid #808080;" cols="50" name="remarks" class=" form-control" placeholder="Remarks" id=""> <?php echo  $purchase_info[0]['remarks']; ?></textarea>
