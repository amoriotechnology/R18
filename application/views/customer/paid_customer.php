...
<div id="myModal_colSwitch"  class="modal_colSwitch">
                    <div class="modal-content_colSwitch" style="width:25%;height:28%;">
        ...
        <br><input type="checkbox"  data-control-column="8" checked = "checked" class="opt Paid Amount" value="Paid Amount"/>&nbsp;<?php  echo  display('due_amount')?><br>
                          </div>
                       </div>
