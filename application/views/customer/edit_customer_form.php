      ...
      <option value="CAD">CAD</option>
        ...
        <option value="180DAYS">180<?php echo display('DAYS');?></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" name="previous_balance" id="previous_balance" value="{credit_limit}" type="text" min="0"  tabindex="5" required="">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
...
<div class="form-group row">
    ...
    <select name="tax_status" class="form-control"  id="tax_dropdown" tabindex="3" style="width:100%">
                               <?php if($tax_status =='1') { ?>     
