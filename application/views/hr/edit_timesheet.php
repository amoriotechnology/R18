...
<input  type="hidden"   readonly id="tsheet_id" value="<?php echo $time_sheet_data[0]['timesheet_id'];?>" name="tsheet_id" />
     ...
     <?php  } ?>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-7">
                                <select name="duration" <?php if($time_sheet_data[0]['uneditable']==1){ echo 'disabled';}  ?>  id="duration"  class="form-control datepicker"  style="width: 420px;" >
          ...
          <option value="<?php echo $inv['duration_name'] ; ?>"><?php echo $inv['duration_name'] ; ?></option>
                        ...
                        <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                        <input type="text" name="job_title" id="job_title" <?php if($time_sheet_data[0]['uneditable']==1){ echo 'readonly';}  ?> placeholder="Job title" value="<?php  echo $designation; ?>" class="form-control">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="dailybreak"  id="dailybreak" <?php if($time_sheet_data[0]['uneditable']==1){ echo 'disabled';}  ?>  class="form-control datepicker"  style="width: 420px;" >
          ...
          <option value="<?php echo $dbd['dailybreak_name'] ; ?>"><?php echo $dbd['dailybreak_name'] ; ?></option>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input id="reportrange" type="text" name="date_range" <?php if($time_sheet_data[0]['uneditable']==1){ echo 'readonly';}  ?> value="<?php echo $time_sheet_data[0]['month'] ; ?>" class="form-control"/>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <?php  } else { ?>
                                        <select name="payment_term" id="terms" <?php if($time_sheet_data[0]['uneditable']==1){ echo 'disabled';}  ?> class="form-control" onchange="get_customer_info(this.value)"  style="width: 420px;"  data-placeholder="<?php echo display('select_one'); ?>">
          ...
          <option value="<?php echo $inv['payment_terms'] ; ?>"><?php echo $inv['payment_terms'] ; ?></option>
            ...
            <td  class="date" ><input type="text" <?php if($time_sheet_data[0]['uneditable']==1){ echo 'readonly';}  ?> value="<?php  echo $tsheet['Date'] ?>" name="date[]"   /></td>
            <td  class="day" ><input type="text" <?php if($time_sheet_data[0]['uneditable']==1){ echo 'readonly';}  ?> value="<?php  echo $tsheet['Day'] ?>" name="day[]"   /></td>
            <td class="start-time">    <input   <?php if($time_sheet_data[0]['uneditable']==1){ echo 'readonly';}  ?>  name="start[]"  class="hasTimepicker start" value="<?php  echo $tsheet['time_start'] ?>" type="time"   /></td>
            <td class="finish-time">   <input   <?php if($time_sheet_data[0]['uneditable']==1){ echo 'readonly';}  ?>    name="end[]" class="hasTimepicke end"  value="<?php  echo $tsheet['time_end'] ?>"  type="time"   /></td></td>
            <td class="hours-worked">  <input  readonly   name="sum[]" class="timeSum"   value="<?php  echo $tsheet['hours_per_day'] ?>"  type="text"   /></td></td>
                    ...
                    <td style="text-align: center;"> <input  type="text"  readonly  style="text-align:left;" id="total_net" value="<?php echo $time_sheet_data[0]['total_hours'] ; ?>" name="total_net" />    </td> 
                                            </tr> 
 ...
 <input type="submit"  style="float:right;<?php if($time_sheet_data[0]['uneditable']==1){ echo 'display:none;';}  ?>color:white;background-color: #38469f;" value="Generate pay slip"   class="btn btn-info m-b-5 m-r-2"/> 
