...
<div class="col-sm-6" id="payment_from_1">
   ...
   <div class="form-group row">
        ...
        <select name="designation" id="designation" class="form-control" style="width: 115%;" required>
...
<div class="form-group row">
<label for="rate_type" class="col-sm-4 col-form-label">
Payment Type
 </label>
...
<select name="rate_type" id="paytype" class="form-control" style="width: 115%;" >
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input name="ssn" class="form-control" type="text" placeholder="Social security number" value="<?php echo html_escape($employee_data[0]['social_security_number'])?>" >
                        ...
                        <div class="col-sm-4">
                            ...
                            <input name="routing_number" class="form-control" type="text" placeholder="Routing number" value="<?php echo html_escape($employee_data[0]['routing_number'])?>" >
