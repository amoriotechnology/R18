...
<div class="content-wrapper">
   ...
   <?php echo form_open('Admin_dashboard/date_wise_closing_reports/', array('class' => 'form-inline', 'method' => 'get')) ?>
                        ...
                        <button type="submit" class="btn btnclr" style="background-color: #3CA5DE; color: #fff;"><?php echo display('search') ?></button>
                        <?php echo form_close() ?>	
                        <!-- <div class="col-sm-1">
                     <a onclick="reload();"  >  <i class="fa fa-refresh" style="font-size:25px;float:right;" aria-hidden="true"></i> </a>
                     </div> -->
    ...
    &nbsp;
    <input type="button" class="btn btnclr" name="btnPrint" id="btnPrint"   value="Print" onclick="printDiv('printableArea');"/>
                                ...
                                <table class="table table-striped " id="ProfarmaInvList">
                                    ...
                                    <thead class="sortableTable">
                                        <tr class="sortableTable__header">
                                            ...
                                            <th class="2 value" data-col="2" data-resizable-column-id="2"><?php echo display('date') ?></th>
                                          
                                            <th class="3 value" data-col="3" data-resizable-column-id="3" ><?php echo display('cash_in') ?></th>
                                            <th class="4 value" data-col="4" data-resizable-column-id="4" ><?php echo display('cash_out') ?></th>
                                            <th class="5 value" data-col="5" data-resizable-column-id="5" ><?php echo display('balance') ?></th>
                                        </tr>
                                    </thead>
...
<div id="myModal_colSwitch"  class="modal_colSwitch">
                    ...
                    <span class="close_colSwitch">&times;</span>
                          ...
                          <br><input type="checkbox"  data-control-column="3" checked = "checked" class="3 " value="3  "/>&nbsp;<?php echo ('Cash In')?> <br>
             </div>
        </div>
        ...
        <div class="form-group row"  >
        <br><input type="checkbox"  data-control-column="4" checked = "checked" class="4" value="4"/>&nbsp;<?php echo ('Cash Out')?><br>

        <br><input type="checkbox"  data-control-column="5" checked = "checked" class="5" value="5"/>&nbsp;<?php echo display('Balance')?><br>
