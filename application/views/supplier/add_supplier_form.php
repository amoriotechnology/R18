            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading" style="height: 55px;" >
                        ...
                        <a href="<?php echo base_url('Csupplier/manage_supplier') ?>"  style="color:white;background-color:#38469f;" class="btn btn-large"   float: right; "><i class="ti-align-justify"> </i>  <?php echo ('Manage Vendor') ?> </a>
 </div>   
...
<div class="col-sm-6">
   ...
   <div class="form-group row">
    ...
    <option value="ZMK">ZMK - Zambian Kwacha - ZK</option>
                            ...
                            <div class="col-sm-1">
                                <input type="submit" id="add-supplier"  style="color:white;background-color:#38469f;" class="btn btn-large"  name="add-supplier"   value="<?php echo display('save') ?>" tabindex="6"/>                   
                            </div>
                            </div>
