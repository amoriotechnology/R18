...
<input type="submit" id="add-supplier"   name="add-supplier" value="<?php echo ('save') ?>" tabindex="5" />
                            ...
                            <div class="col-sm-2">
                                <input type="submit" id="add-supplier"  class="btn btnclr dropdown-toggle" style="color:white;background-color:#38469f;"  name="add-supplier"   value="<?php echo display('save') ?>" tabindex="6"/>
