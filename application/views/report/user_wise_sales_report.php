  ...
  <caption class="text-center"><b><?php echo display('from')?>: </b>{from} <b><?php echo display('to')?>:</b> {to} <br>
                                    ...
                                    <thead class="sortableTable">
                                        <tr style="background-color: #337ab7;border-color: #2e6da4;" class="sortableTable__header">
                                            <th data-col="1" data-control-column="1" class="1 value" name="Sale Date" style="height: 35.0114px;"> Sl.No</th>
                                            <th data-col="2" data-control-column="2" class="2 value" name="Sale Date" style="height: 35.0114px;">User Name</th>
                                            <th data-col="3" data-control-column="3" class="3 value" name="Sale Date" style="height: 35.0114px;">Total Invoice</th>
                                            <th data-col="4" data-control-column="4" class="4 value" name="Sale Date" style="height: 35.0114px;">Total Amount</th>
                                ...
                                <tr style="text-align:center;">
                                    <td data-col="1" class="1"><?php echo $sl;?></td>
                                    <td data-col="2" class="2"><?php echo html_escape($sales['first_name']).' '.html_escape($sales['last_name'])?></td>
                                    <td data-col="3" class="3">
                            ...
                            <?php $sl++;} else {
                                ...
                                <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="3" class="text-center 3" data-col="3" ><b><?php echo display('total_seles') ?></b></td>
                                            <td class="text-center 4" data-col="4"><b><?php if($position == 0){
