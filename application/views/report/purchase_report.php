...
<div class="sortableTable__container">
  ...
  <thead class="sortableTable" >
    ...
    <?php
                                        if ($purchase_report) {
                                            ...
                                            <tr>
                                                <td data-col="1" style="text-align:center;" class="1" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($row['prchse_date']) ?></td>
                                                <td data-col="2" style="text-align:center;" class="2" bgcolor="<?php echo $bg; ?>">
                                                   
                                                        <?php echo html_escape($row['chalan_no']) ?>
                                                   
                                                </td>
                                                <td data-col="3" style="text-align:center;" class="3" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($row['supplier_name']) ?></td>
                                                
                                                <td class="4" style="text-align:center;" data-col="4" bgcolor="<?php echo $bg; ?>"><?php echo (($position == 0) ? "$currency " .number_format($row['grand_total_amount'],2) : number_format($row['grand_total_amount'],2)." $currency") ?></td>
  ...
  <tr>
                                            ...
                                            <td   class="3" data-col="3" style="text-align:right;">&nbsp; <b><?php echo display('total_purchase') ?> </b></td>
                                            <td class="4" data-col="4" style="text-align:center;"><b><?php echo (($position == 0) ? "$currency ".$purchase_amount : $purchase_amount ." $currency") ?></b></td>
                                        </tr>

<?php
}  else{
    ?>
     <tr><td colspan="4" style="text-align:center;font-weight:bold;"><?php  echo "No Records Found"  ;?></td></tr>
    <?php
          }
