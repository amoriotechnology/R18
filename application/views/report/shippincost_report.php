...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?php echo display('shipping_cost_report') ?></small>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url()?>"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('report') ?></a></li>
                <li class="active"><?php echo display('shipping_cost_report') ?></li>
            </ol>
        </div>
    </section>
...
<div class="sortableTable__container">
  ...
  <table class="table"  id="ProfarmaInvList">
                                        ...
                                        <tr style="background-color: #337ab7;border-color: #2e6da4;" class="sortableTable__header">
                                            <th data-col="1" data-control-column="1" class="1 value" name="Sale Date" style="height: 35.0114px;">Sales Date</th>
                                            <th data-col="2" data-control-column="2" class="2 value" name="Invoice No" style="height: 35.0114px;">Invoice No</th>
                                            <th data-col="3" data-control-column="3" class="3 value" name="Shipping Cost" style="height: 35.0114px;">Shipping Cost<?php echo form_open('Admin_dashboard/retrieve_dateWise_Shippingcost', array('class' => 'form-inline', 'method' => 'get')) ?>
                                ...
                                $bg="#FFFFFF";
                                            ...
                                            <td colspan="1" class="2 text-left"  data-col="2"><b><?php echo display('total') ?></b></td>
...
<input type="checkbox"  data-control-column="2" checked = "checked" class="2"  value="2"/>Invoice Date<br>
<input type="checkbox"  data-control-column="3" checked = "checked" class="3"   value="3"/>Shipping Cost<br>
