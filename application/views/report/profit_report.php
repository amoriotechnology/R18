...
<input type="checkbox"  data-control-column="3" checked = "checked" class="3"   value="3"/>Supplier Amount<br>
<input type="checkbox"  data-control-column="4" checked = "checked" class="4"   value="4"/>My Sale Amount <br>
<input type="checkbox"  data-control-column="5" checked = "checked" class="5"   value="5"/>Total Profit <br>
