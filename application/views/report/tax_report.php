...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('tax_report') ?></h1>
            <small><?php //echo display('tax_report') ?></small>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url()?>"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('report') ?></a></li>
                <li class="active" style="color:orange;"><?php echo display('tax_report') ?></li>
            </ol>
        </div>
    </section>
    ...
    <?php if($this->permission1->method('todays_sales_report','read')->access() && $this->permission1->method('todays_purchase_report','read')->access()){ ?>
        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <?php echo form_open('Admin_dashboard/retrieve_dateWise_tax', array('class' => 'form-inline', 'method' => 'get')) ?>                        <?php
                        $today = date('Y-m-d');
                        ?>
...
<option value="3">Total Tax</option>
...
<div class="sortableTable__container">
  ...
  <table class="table"  id="ProfarmaInvList">
                                        ...
                                        <th data-col="1" data-control-column="1" class="1 value" name="Sales Date" style="height: 35.0114px;">Sales Date</th>
                                            <th data-col="2" data-control-column="2" class="2 value" name="Invoice No" style="height: 35.0114px;">Invoice No</th>
                                            <th data-col="3" data-control-column="3" class="3 value" name="Total Tax" style="height: 35.0114px;">Total Tax<?php echo form_open('Admin_dashboard/retrieve_dateWise_tax', array('class' => 'form-inline', 'method' => 'get')) ?>
                                ...
                                $bg="#FFFFFF";
                                            ...
                                            <tr>
                                                <td data-col="1" class="1" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($sales['sales_date'])?></td>
                                                <td data-col="2" class="2" bgcolor="<?php echo $bg; ?>">
                                                   
                                                        <?php echo html_escape($sales['invoice_id'])?>
                                                 
                                                </td>
                                       
                                                <td data-col="3" class="3 text-left" bgcolor="<?php echo $bg; ?>"><?php
                                                 if($position == 0){
                                              echo $currency.' '.($sales['total_tax']);  
                                            }else{
                                            echo ($sales['total_tax']).$currency; 
                                            }
...
<input type="checkbox"  data-control-column="3" checked = "checked" class="3"   value="3"/>Total Tax<br>
