    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active" style="color:orange;"><?php echo 'Stock Report'; ?></li>
            </ol>
...
<div class="sortableTable__container">
  ...
  <thead class="sortableTable">
      ...
      <th class="1 value" data-col="1"data-control-column="1">S.No</th>
        ...
        <th class="4 value" data-col="4" data-control-column="4">Stock</th>
         <th class="5 value" data-col="5" data-control-column="5">Availability</th>
        
                  <th class="6 value"data-col="6" data-control-column="6" style="color:white;" >Serial No</th>
     ...
     <tbody class="sortableTable__body" id="tab">
              ...
              data-supplier="<?php echo $product['supplier_name']; ?>">
                            ...
                            <td data-col="1" style="text-align:center;" class="1" bgcolor="<?php echo $bg; ?>"><?php echo $i; ?></td>
                            <td data-col="2" class="2" bgcolor="<?php echo $bg; ?>"><a href="<?php echo base_url().'Cproduct/'; ?>product_view/<?php echo $product['product_id']; ?>"><?php echo $product['product_name']; ?></a></td>
                            <td data-col="3" class="3" bgcolor="<?php echo $bg; ?>"><?php echo $product['product_model']; ?></td>
                            <td data-col="4"  class="4"style="text-align: -webkit-center;" bgcolor="<?php echo $bg; ?>">
                          <?php echo $product['p_quantity']; ?></td>
                          <td data-col="5"  class="5"style="text-align: -webkit-center;" bgcolor="<?php echo $bg; ?>">
     <?php  
     $sale_sum=false;
     $s=0;
     $e=0;
...
$total =$s+$e;
  ...
  ?>
                                    ...
                                    <td data-col="6" class="6" bgcolor="<?php echo $bg; ?>"><?php  echo $product['serial_no']; ?></td>
...
<iframe id="txtArea1" style="display:none"></iframe>
   ...
   <div id="myModal_colSwitch" class="modal_colSwitch">
                    <div class="modal-content_colSwitch" style="width:15%;height:35%;">
    ...
    <input type="checkbox"  data-control-column="4" checked = "checked" class="4"   value="4"/>Stock<br>
  
    <input type="checkbox"  data-control-column="5" checked = "checked" class="5"   value="5"/>Availability<br>

    <input type="checkbox"  data-control-column="6" checked = "checked" class="6"   value="6"/>Serial No<br>
