...
{
 ?> <a  class="btn btnclr" href="#" onclick="printDiv('printableArea')"><?php echo display('print'); ?></a> <?php }  ?>
 ...
 <div class="sortableTable__container">
                              ...
                              <table width="100%" class="table table-stripped" id="ProfarmaInvList">
                                    ...
                                    <thead class="sortableTable" style="height:30px;">
                                        ...
                                        <tr class="sortableTable__header">
                                            ...
                                            <th class="2 value" data-col="2" data-resizable-column-id="2"><?php echo display('customer_name'); ?></th>

                                            <th class="3 value" data-col="3" data-resizable-column-id="3" ><?php echo display('description'); ?></th>

                                            <th class="4 value" data-col="4" data-resizable-column-id="4"><?php echo display('receipt'); ?></th>
  ...
  if($i&1)
                                ...
                                <tr>
                                    ...
                                    <td  data-col="2" class="2" bgcolor="<?php echo $bg; ?>"> <?php echo html_escape($single->HeadName); ?></td>

                                    <td  data-col="3" class="3" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->Narration); ?></td>
       ...
       <td  data-col="1" class="1">&nbsp;</td>
         <td  data-col="2" class="2">&nbsp;</td>
                                            ...
                                            <td  data-col="3" class="3" style="text-align:right;"><b><?php echo display('total'); ?></b></td>
...
<input type="checkbox"  data-control-column="2" checked = "checked" class="2"  value="2"/>Customer Name<br>
<input type="checkbox"  data-control-column="3" checked = "checked" class="3"   value="3"/>Description<br>
<input type="checkbox"  data-control-column="4" checked = "checked" class="4"   value="4"/>Receipt<br>
