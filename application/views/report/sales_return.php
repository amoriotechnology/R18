...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('invoice_return') ?></h1>
            <small><?php //echo display('invoice_return') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('report') ?></a></li>
                <li class="active" style="color:orange;"><?php echo display('invoice_return') ?></li>
            </ol>
        </div>
    </section>
        <!-- Main content -->
    ...
    <?php if($this->permission1->method('todays_sales_report','read')->access() && $this->permission1->method('todays_purchase_report','read')->access()){ ?>
        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <?php echo form_open('Admin_dashboard/sales_return', array('class' => 'form-inline', 'method' => 'get')) ?>
                        <?php
                        $today = date('Y-m-d');
                        ?>
...
<div class="sortableTable__container">
  ...
  <table class="table"  id="ProfarmaInvList">
                                        ...
                                        <th data-col="1" data-control-column="1" class="1 value" name="Sl" style="height: 35.0114px;">Sl</th>
                                        ...
                                        <th data-col="5" data-control-column="5" class="5 value" name="Total Amount" style="height: 35.0114px;">Total Amount</th>
                                ...
                                $bg="#FFFFFF";
                                                ?>
                                        <tr>
                                            <td data-col="1" class="1" bgcolor="<?php echo $bg; ?>"> {sl}</td>
                                            <td data-col="2" class="2" bgcolor="<?php echo $bg; ?>">
                                      
                                                    {invoice_id}
                                               
                                            </td>
                                            <td data-col="3" class="3" bgcolor="<?php echo $bg; ?>">
                                            <td >
                                              {customer_name}				
                                            </td>

                                            <td data-col="4" class="4" bgcolor="<?php echo $bg; ?>">
                                            <td bgcolor="<?php echo $bg; ?>">{final_date}</td>
                                            <td data-col="5" class="5 text-right" bgcolor="<?php echo $bg; ?>"><?php echo (($position == 0) ? "$currency {net_total_amount}" : "{net_total_amount} $currency") ?></td>
    ...
    <!-- The Modal Column Switch -->
           <div id="myModal_colSwitch" class="modal_colSwitch" >
                    <div class="modal-content_colSwitch" style="width:10%;height:25%;">
                          ...
                          <input type="checkbox"  data-control-column="1" checked = "checked" class="1"  value="1"/>Sl<br>
