...
<div id="myModal_colSwitch"  class="modal_colSwitch">
                    ...
                    <span class="close_colSwitch">&times;</span>
                          ...
                          <br><input type="checkbox"  data-control-column="1" checked = "checked" class="1" value="1"/>&nbsp;<?php echo ('Sl')?><br>
                          <br><input type="checkbox"  data-control-column="2" checked = "checked" class="2" value="2"/>&nbsp;<?php echo ('Invoice ID')?><br>
