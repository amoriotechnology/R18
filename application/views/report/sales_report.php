    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active" style="color:orange;"><?php echo display('sales_report') ?></li>
            </ol>
        </div>
    </section>
...
{
 ?>   <a  class="btn btnclr" href="#" onclick="printDiv('printable')"><?php echo display('print') ?></a> <?php  } ?>
                        <?php echo form_close() ?> 
                        </div>
...
<option value="2">Invoice ID</option>
...
<div class="sortableTable__container">
  ...
  <p style="text-align:center;">  <caption style="text-align:center;"><b><?php echo display('from')?>: <?php echo (!empty($_GET['from_date'])?html_escape($_GET['from_date']):''); ?> </b><b><?php echo display('to')?>:<?php echo (!empty($_GET['to_date'])?html_escape($_GET['to_date']):''); ?> </b></caption></p>
                                  <p style="text-align:right;">     <caption > <b><?php echo display('total_sold')?>: </b>{currency} {sales_amount} </caption></p>
                    <div id="customers">
  <table class="table table-stripped"  id="ProfarmaInvList">
                                        ...
                                        <tr style="background-color: #337ab7;border-color: #2e6da4;" class="sortableTable__header">
                                            ...
                                            <th data-col="2" data-control-column="2" class="2 value" name="Invoice ID" style="height: 35.0114px;">Invoice ID</th>
                                            <th data-col="3" data-control-column="3" class="3 value" name="Customer Name" style="height: 35.0114px;">Customer Name</th>
                                            <th data-col="4" data-control-column="4" class="4 value" name="Total Amount" style="height: 35.0114px;">Total Amount<?php echo form_open('Admin_dashboard/retrieve_dateWise_SalesReports', array('class' => 'form-inline', 'method' => 'get')) ?>
                                ...
                                $bg="#FFFFFF";
                                                ?>
                             <tr>
                                    <td data-col="1" class="1" bgcolor="<?php echo $bg; ?>"><?php echo $sales['sales_date']?></td>
                                    <td data-col="2" class="2" bgcolor="<?php echo $bg; ?>">
                                            <?php echo $sales['invoice_id']?></td>
                                    <td data-col="3" class="3" bgcolor="<?php echo $bg; ?>"><?php echo $sales['customer_name']?></td>
                            <td data-col="4" class="4" bgcolor="<?php echo $bg; ?>">
                                    <?php 
                                if($position == 0){
                                ...
                                $subtotal += $sales['total_amount']; ?>
                                            ...
                                            <?php $i++;} ?>
                                              <tr>
                                            <td class="1" data-col="1">&nbsp;</td>
                                            <td class="2" data-col="2">&nbsp;</td>
                                            <td  class="3" data-col="3" ><b><?php echo display('total_seles') ?></b></td>
                                            <td class="4" data-col="4"><b><?php echo (($position == 0) ? "$currency ". number_format($subtotal) : number_format($subtotal) ." $currency") ?></b></td>
                                        </tr>
                                        <?php } else {
                                            ?>
    ...
    <!-- The Modal Column Switch -->
           <div id="myModal_colSwitch" class="modal_colSwitch" >
                    <div class="modal-content_colSwitch" style="width:10%;height:25%;">
                          ...
                          <input type="checkbox"  data-control-column="1" checked = "checked" class="1"  value="1"/>Sale Date<br>
<input type="checkbox"  data-control-column="2" checked = "checked" class="2"  value="2"/>Invoice ID<br>
<input type="checkbox"  data-control-column="3" checked = "checked" class="3"   value="3"/>Customer Name<br>
