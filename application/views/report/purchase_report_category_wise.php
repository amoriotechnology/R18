    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active" style="color:orange"><?php echo display('category_wise_purchase_report') ?></li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <button type="submit"  class="btn btnclr" name="btnSave"><?php echo display('find') ?></button>
                         <a  class="btn btnclr" href="#" onclick="printDiv('printable')" style="background-color: #337AB7;border-color: #2E6DA4;"><?php echo display('print') ?></a>
                                </div>
                      <?php if(isset($_POST['btnSave']))
{
 ?>
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
      ...
      <li><a href="#" id="cmd" onclick="generate()"> <img src="<?php echo base_url()?>assets/images/pdf.png" width="24px"> PDF</a></li>
...
<div class="sortableTable__container">
  ...
  <thead class="sortableTable">
                                        <tr style="background-color: #337ab7;border-color: #2e6da4;" class="sortableTable__header">
                                            ...
                                            <th data-col="5" data-control-column="5" class="5 value" name="Quantity" style="height: 35.0114px;">Quantity</th>
                                    ...
                                    <tbody class="sortableTable__body">
                                        ...
                                        if ($purchase_report_category_wise) {
                                            foreach ($purchase_report_category_wise as $single) {
                                                ...
                                                ?>
                                                <tr>
                                        <td data-col="1" class="1" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->category_name); ?></td>
                                        <td data-col="2" class="2" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->product_name); ?></td>
                                        <td data-col="3" class="3" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->product_model); ?></td>
                                        <td data-col="4" class="4" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->purchase_date); ?></td>
                                        <td data-col="5" class="5" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->p_quantity); ?></td>
                                        <td class="6" data-col="6" bgcolor="<?php echo $bg; ?>"><?php echo (($position == 0) ? $currency.' '.number_format($single->total_amount,2) : number_format($single->total_amount,2).' '. $currency);
                                        $total +=$single->total_amount;
                                         ?></td>
                                            ...
                                            <td  class="5" data-col="5" style="text-align:right;"><b><?php echo display('total_seles') ?></b></td>
...
<input type="checkbox"  data-control-column="5" checked = "checked" class="5"   value="5"/>Quantity<br>
...
$('#cmd').click(function() {
 ...
 for (var i = 1; i <= totalPages; i++) {
  ...
  }).save('Purchase_Report_Categorywise.pdf');
    setTimeout( function(){
