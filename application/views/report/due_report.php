...
<div class="sortableTable__container">
  ...
  <thead class="sortableTable">
                                        <tr style="background-color: #337ab7;border-color: #2e6da4;" class="sortableTable__header">
                                            ...
                                            <th data-col="4" data-control-column="4" class="4 value" name="Total Amount" style="height: 35.0114px;"> Total Amount</th>
                                            <th data-col="5" data-control-column="5" class="5 value" name="Paid Amount" style="height: 35.0114px;"> Paid Amount</th>
                                            <th data-col="6" data-control-column="6" class="6 value" name="Due Amount" style="height: 35.0114px;"> Due Amount<?php echo form_open('Admin_dashboard/retrieve_dateWise_DueReports', array('class' => 'form-inline', 'method' => 'get')) ?>
                                    ...
                                    <tbody class="sortableTable__body">
                                        ...
                                        <td data-col="2" class="2" bgcolor="<?php echo $bg; ?>">
                                                ...
                                                <?php echo html_escape($sales['commercial_invoice_number'])?></td>
                                        <td data-col="3" class="3" bgcolor="<?php echo $bg; ?>"><?php echo $sales['customer_name']?></td>
                                        <td data-col="4" class="4" bgcolor="<?php echo $bg; ?>"><?php  if($position == 0){
                                         ...
                                         <td data-col="5" class="5" bgcolor="<?php echo $bg; ?>"><?php
                                            ...
                                            echo (int)$sales['amount_pay_usd'].' '.$currency; 
                                                ...
                                                ?></td>
                                                <td data-col="6" class="6" bgcolor="<?php echo $bg; ?>"><?php
                                                 if($position == 0){
                                            ...
                                            <td data-col="3" class="3 text-right" ><b><?php echo display('total') ?></b></td>
                                            <td class="4 text-center" data-col="4"><b><?php echo (($position == 0) ? $currency.' '.number_format($subtotal) : number_format($subtotal).' '. $currency) ?></b></td>
                                            <td class="5 text-center" data-col="5"><b><?php echo (($position == 0) ? $currency.' '. number_format($subtotal_paid) : number_format($subtotal_paid).' '. $currency) ?></b></td>
                                            <td class="6 text-center" data-col="6"><b><?php echo (($position == 0) ? $currency.' '. number_format($subtotal_due) : ($subtotal_due).' '. $currency) ?></b></td>
                                        </tr>
...
<input type="checkbox"  data-control-column="5" checked = "checked" class="5"   value="5"/>Paid Amount<br>
<input type="checkbox"  data-control-column="6" checked = "checked" class="6"  value="6"/>Due Amount<br>
