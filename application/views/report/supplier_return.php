...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        <h1><?php echo display('supplier_return') ?></h1>
	        <small><?php //echo display('supplier_return') ?></small>
	        <ol class="breadcrumb">
	            <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
	            <li><a href="#"><?php echo display('report') ?></a></li>
	            <li class="active" style="color:orange;"><?php echo display('supplier_return') ?></li>
	        </ol>
	    </div>
	</section>
    ...
    <?php if($this->permission1->method('todays_sales_report','read')->access() && $this->permission1->method('todays_purchase_report','read')->access()){ ?>
        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <?php echo form_open('Admin_dashboard/supplier_return', array('class' => 'form-inline', 'method' => 'get')) ?>
                        <?php 
                        $today = date('Y-m-d');
                        ?>
...
<option value="2">Purchase ID</option>
...
<div class="sortableTable__container">
  ...
  <table class="table"  id="ProfarmaInvList">
										...
										<th data-col="2" data-control-column="2" class="2 value" name="Purchase ID" style="height: 35.0114px;">Purchase ID</th>
										<th data-col="3" data-control-column="3" class="3 value" name="Supplier Name" style="height: 35.0114px;">Supplier Name</th>
                                ...
                                $bg="#FFFFFF";
									...
									<tr>
										...
										<td data-col="4" class="4" bgcolor="<?php echo $bg; ?>">{final_date}</td>
...
<input type="checkbox"  data-control-column="2" checked = "checked" class="2"  value="2"/>Purchase ID<br>
